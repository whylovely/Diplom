...
public static class DtoMapper
{
    ...
    public static AccountDto ToDto(Account a) => new(a.Id, a.Name, (AccountKind)(int)a.Type, a.CurrencyCode, 
        (Shared.Accounts.MultiCurrencyType)(int)a.AccountMultiType, a.SecondaryCurrencyCode, a.ExchangeRate);

    public static CategoryDto ToDto(Category c) => new(c.Id, c.Name);

    public static ObligationDto ToDto(Obligation o) => new(o.Id, o.Counterparty, o.Amount, o.Currency, (Shared.Obligations.ObligationType)(int)o.Type, 
        o.CreatedAt, o.DueDate, o.IsPaid, o.PaidAt, o.Note);

    public static TransactionDto ToDto(Transaction t, IReadOnlyDictionary<Guid, Guid>? accountIdMap = null) => new(t.Id, t.Date, t.Description, 
        t.Entries.Select(e => ToDto(e, accountIdMap)).ToList());

    private static EntryDto ToDto(Entry e, IReadOnlyDictionary<Guid, Guid>? accountIdMap) => new(e.Id,
    ...
    private static readonly HashSet<string> _incomeCategories = new(StringComparer.OrdinalIgnoreCase) { "Зарплата", "Доход", "Фриланс", "Подработка", "Стипендия", "Пенсия", "Инвестиции" };
}