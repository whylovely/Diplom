...
{
    /// <summary>
    /// Presentation-модель для отображения транзакции в журнале.
    /// </summary>
    public sealed class JournalRow
    {
        ...
        public string AccountName { get; set; } = "";  // имя основного счёта
        ...
        public string CurrencyCode { get; set; } = ""; // валюта
